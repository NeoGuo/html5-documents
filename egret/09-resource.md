...
然后来看一下如何设置屏幕适配的策略，首先，打开launcher/egret_loader.js，找到下面的语句(为方便理解，加上了部分注释)：
...
当您需要修改缩放策略，修改launcher/egret_loader.js对应的部分即可。

- - -

[上一篇:事件](https://github.com/NeoGuo/html5-documents/blob/master/egret/08-event.md)
| [下一篇:Tween的使用](https://github.com/NeoGuo/html5-documents/blob/master/egret/10-tween.md)
